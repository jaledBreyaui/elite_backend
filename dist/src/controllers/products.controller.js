...
exports.modifyProudct = exports.deleteProduct = exports.newProduct = exports.getProductById = exports.getProducts = void 0;
const InventarioService_1 = require("../services/InventarioService");
const cloudinary_1 = __importDefault(require("../config/cloudinary"));
const service = new InventarioService_1.InventarioService();
...
const modifyProudct = async (req, res) => {
    try {
        const id = req.params.id;
...
exports.modifyProudct = modifyProudct;
